...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.angular_search_window = math.rad(180.)  -- 增加角度搜索窗口
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 200 -- 减少迭代次数提高速度
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.1)  -- 0.1度
...
-- 匹配阈值优化
POSE_GRAPH.constraint_builder.min_score = 0.55  -- 略微降低近距离匹配阈值
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(120.)  -- 增加角度搜索 45
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher.translation_weight = 50   -- 平衡平移权重
POSE_GRAPH.constraint_builder.ceres_scan_matcher.rotation_weight = 5000      -- 增加旋转权重

TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.grid_type = "PROBABILITY_GRID"
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.05-- 适中的分辨率
